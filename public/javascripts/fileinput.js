...
(function(factory) {
    ...
    FileInput.prototype = {
        ...
        _clearPreview: function() {
            var self = this,
                $thumbs = !self.showUploadedThumbs ? self.$preview.find(FRAMES) :
        ...
        _initZoomButtons: function() {
            var self = this,
                ...
                $first, $last,
                thumbs = self.$preview.find(FRAMES).toArray(),
                len = thumbs.length,
